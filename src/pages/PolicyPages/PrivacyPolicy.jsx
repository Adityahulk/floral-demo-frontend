  ...
  return (
    <div>
      <PageHero
        ...
        subtitle="We care deeply about your privacy. This policy explains how Floral Studio collects, uses, and protects your personal information."
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <Highlight type="success"
          ...
          text="Floral Studio does not sell your personal data to third parties. Your information is used solely to improve your shopping experience with us." />
        ...
        <Section title="Your Rights" icon={<CheckCircle size={16}/>}>
          ...
          <p className="mt-3">To exercise any of these rights, please contact us at <strong style={{ color:"#c97d5b" }}>thefloralstudiosurat@gmail.com</strong>. We will respond within 30 days.</p>
        </Section>
        ...
        <Section title="Cookies" icon={<Cookie size={16}/>}>
          <p>We use cookies and similar tracking technologies on our website. Please refer to our <strong style={{ color:"#c97d5b" }}>Cookie Policy</strong> for full details on the types of cookies we use, why we use them, and how you can manage your preferences.</p>
        </Section>

        <Section title="Children's Privacy" icon={<Shield size={16}/>}>
          <p>Floral Studio is not directed at children under the age of 13. We do not knowingly collect personal information from children. If you believe a child has provided us with personal data, please contact us immediately and we will delete it promptly.</p>
        </Section>
