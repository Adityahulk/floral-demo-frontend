      ...
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-6">
        {banners.map(banner => (
          <div key={banner._id} className="group relative rounded-3xl overflow-hidden h-64 sm:h-72 cursor-pointer">
            ...
            />
            <div className="absolute inset-0" style={{ background: "rgba(46,46,46,0.5)" }} />
            <div className="absolute inset-0 flex flex-col justify-end p-8">
              <span style={{ color: "var(--color-sage)" }} className="text-xs uppercase tracking-widest font-semibold mb-2 line-clamp-1">
                {banner.desc}
              </span>
